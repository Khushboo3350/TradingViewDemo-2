/*
 * @Author: tonyTang 
 * @Date: 2018-11-05 18:49:24 
 * @Last Modified by: tonyTang
 * @Last Modified time: 2018-11-06 10:06:24
 */


 /** 
  * 数据更新器
  * 通过更新器触发datafeeds的getBars实时更新图标数据
 */
class dataUpdater {
    ...
    updateDataForSubscriber(listenerGuid) {
        return new Promise((resolve,reject) => {
            ...
            const rangStartTime = rangeEndTime - this.periodLengthSeconds(subscriptionRecord.resolution,10);
